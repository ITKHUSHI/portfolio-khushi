...
function Skills() {
  return (
    <>
      ...
      <section className=" experience-section relative  p-4  bg-black grid-cols-3 h-[100vh] ">
        ...
        {/* <section className="grid justify-center md:h-[100vh]  h-full items-center bg-black  w-full  ">
        <div className="justify-center items-center flex">
          <h2 className="text-2xl font-bold text-white ">
            My Experience Area
          </h2>
        </div>
        <div className="experience-items  text-white space-x-1 sm:space-x-4 p-2 grid grid-cols-2 sm:grid-cols-3  gap-12  w-full">
              {experties.map((data) => (
                 <div className="experience-item  shadow-lg shadow-cyan-400 p-2 rounded-md w-full  ">
